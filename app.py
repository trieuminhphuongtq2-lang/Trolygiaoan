...
<div class="main-header">
    ...
    <p>Tác giả: Triệu Minh Phương - Trường tiểu học Ngọc Đường - ĐT: 0866574025</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Triệu Minh Phương - Trường tiểu Học Ngọc Đường - ĐT: 0866574025</div>", unsafe_allow_html=True)
